...
const articles = ref([
  ...
  { id: 12, link: '/page12', name: 'Каковы 5 «П» сотрудничества?', about: 'Как команды становятся сильнее, чем сумма своих частей' },
...
// Избранные ID статей
const favoriteIds = [4, 5, 6, 7, 9, 10, 12, 15, 16, 17, 18, 20];
